...
# 2. Halaman Galeri (BARU DITAMBAHKAN)
@app.get("/galeri")
def galeri():
    # Anda bisa menambahkan logika pengambilan foto dari database di sini nanti jika diperlukan
    # Sementara ini, langsung memanggil file HTML
...
# 5. Halaman Dashboard Admin (Butuh Login)
@app.get("/admin")
@login_required
def admin_dashboard():
    return render_template('admin.html')

# 6. Route untuk memproses CSV dan mengupdate Database (Butuh Login)
@app.post("/run")
@login_required
def run_apriori():
